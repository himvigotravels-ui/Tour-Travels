...
export function ServiceCard({
  ...
  const accentText =
    accent === "blue" ? "text-brand-blue" : "text-brand-orange";
  ...
  return (
    ...
    >
      ...
      <div className="p-5 sm:p-7">
        ...
        >
          {ctaLabel}
          <span className={`flex h-7 w-7 items-center justify-center rounded-full ${accentBg} text-white transition-transform duration-300 group-hover:rotate-45`}>
